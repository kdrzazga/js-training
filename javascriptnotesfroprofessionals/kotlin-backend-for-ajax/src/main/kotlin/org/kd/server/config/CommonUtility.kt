...
class CommonUtility {
    ...
    private var errorResponseStatusCode: String? = null
    private var errorResponseBody: String? = null
    ...
    fun processHttpRequest(
        httpMethod: HttpMethod, request: String, requestUrl: String, contentType: String
